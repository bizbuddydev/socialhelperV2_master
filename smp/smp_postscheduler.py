    ...
    with st.expander("Add an AI generated Post"):
        ...
        if st.button("Add AI Generated Post", key="generate_post_id"):
            with st.spinner("Generating and adding post..."):
                ...
                strategy = {
                    "content_plan": [
                        "Sterling Mental Performance should focus on a mix of engaging, educational, and conversion-driven content to attract athletes looking to strengthen their mental game. Their Reels should include quick mindset tips on topics like overcoming performance anxiety, improving focus under pressure, and building confidence through visualization techniques. Educational breakdowns of common mental roadblocks, with actionable strategies to overcome them, will position them as an authority in the space. To build trust, they should feature client success stories, testimonials, or behind-the-scenes sessions with athletes discussing their mental performance breakthroughs. Lastly, strategic promotional posts (such as limited-time coaching offers, mental training program breakdowns, or live Q&A sessions) should be used to convert engaged viewers into clients."
                    ],
