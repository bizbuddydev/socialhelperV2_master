...
def main():
    ...
    with st.expander("Add an AI generated Post"):
        ...
        user_context = st.text_area("Optional: Add context for this post idea (e.g., seasonal theme, specific campaign focus, etc.)", "e.g. I wanna post using this trend... I wanna promote a new product/service... ect.")
